...
$(document).ready(function () {
    ...
    // Increment / Decrement
    $('.traveler-menu .plus, .traveler-menu .minus').click(function () {
    ...
    $('#doneBtn').click(function () {
        ...
        const infants = $('#infantCount').text();
        const travelClass = $('input[name="classType"]:checked').val();
        $('#travelerText').text(`${adults} Travelers, ${travelClass}`);
        $('#travelerMenu').hide();
    });

    // Hide menu if clicked outside
    $(document).click(function (e) {
        if (!$(e.target).closest('.traveler-dropdown').length) {
            $('#travelerMenu').hide();
        }
    });
});
